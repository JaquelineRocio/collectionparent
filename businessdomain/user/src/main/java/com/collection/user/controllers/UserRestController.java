 ...
 */
package com.collection.user.controllers;

import com.collection.user.entities.User;
import com.collection.user.entities.UserRol;
import com.collection.user.repositories.UserRepository;
...
public class UserRestController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> put(@PathVariable("id") long id, @RequestBody User input) {
        Optional<User> userOptional = userRepository.findById(id);
        if (userOptional.isPresent()) {
            User modifyUser = userOptional.get();
            modifyUser.setFirstName(input.getFirstName());
            modifyUser.setLastName(input.getLastName());
            modifyUser.setRoles(input.getRoles());
            User saveUser = userRepository.save(modifyUser);
    ...
    public ResponseEntity<?> post(@RequestBody User input) {
        ...
        User newUser = userRepository.save(input);
    ...
    public ResponseEntity<?> delete(@PathVariable("id") long id) {
     ...
     @GetMapping("/full")
    public User getByCode(@RequestParam(name = "lastName") String lastName) {
